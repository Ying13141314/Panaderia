        ...
        <div class="card">
            <div class="card-header">
                <div class="float-start">
                    Agregar producto al pedido #{{$pedido->id}}
                </div>
                <div class="float-end">
                    <a href="{{ route('pedidos.edit', $pedido->id) }}" class="btn btn-primary btn-sm">&larr; Volver</a>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('pedidoProducto.store') }}" method="post">
                    @csrf
